...
fn rocket() -> rocket::Rocket<rocket::Build> {
    ...
    rocket::build()
        ...
        .mount("/", routes![
            ...
            handlers::health_check,          // Health check endpoint
            handlers::get_connections,       // Connection management
            handlers::get_playlist,          // Playlist endpoint
            handlers::debug_connections,     // Debug endpoint
            ...
            direct_stream::radio_stream,     // Alternative streaming endpoint
